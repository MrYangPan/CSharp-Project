...
var viewModel = function (settings) {
    ...
    this.init = function () {
        ...
        document.title = login.settings.globalSettings.ProductName;
        $('.title-zh').html(login.settings.globalSettings.ProductName);
        $('.title-en').html(login.settings.globalSettings.ProductEngName);
    };
