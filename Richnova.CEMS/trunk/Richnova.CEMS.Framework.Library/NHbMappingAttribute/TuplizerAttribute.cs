...
namespace NHibernate.Mapping.Attributes
{
	...
	[System.Serializable()]
	public class TuplizerAttribute : BaseAttribute
	{
		
		private TuplizerEntityMode _entitymode = TuplizerEntityMode.Unspecified;
		
		private string _class = null;
		
		/// <summary> Default constructor (position=0) </summary>
		public TuplizerAttribute() : 
				base(0)
		{
		}
		
		/// <summary> Constructor taking the position of the attribute. </summary>
		public TuplizerAttribute(int position) : 
				base(position)
		{
		}
